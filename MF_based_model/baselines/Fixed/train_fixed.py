...
if __name__ == "__main__":
    ...
    feature_data['loss_{}'.format(fixed_emb_size)] = pd.DataFrame([[i] for i in train_sample_loss])
    feature_data['acc_{}'.format(fixed_emb_size)] = pd.DataFrame([[i] for i in train_sample_accuracy])
