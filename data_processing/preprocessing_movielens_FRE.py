...
Train_Size = 16000000     # 5000000 10000000 15000000 27000000
Output_Dim = 1           # 1 5
DATA_SET_NAME = 'ml-20m' # 'ml-20m' 'ml-25m' 'ml-27m'
DATA_PATH     = '../data'
...
"""
# Get the popularity for each userID in the whole training set
for line in train_features[:,0]:
    if line in user_count_dict:
        user_count_dict += 1
    else:
